...
$root_path = 'C:\xampp\htdocs\allUser\prueba\contents';
...
if (isset($_GET['view'])) {
    ...
    ?>
    <div class="row">
        <div style="background-color:#101010;color:white" class="col-12">
            <?php if(!$quickView) { ?>
            ...
            if($is_onlineViewer) {
                ...
                if (FM_USE_HIGHLIGHTJS) {
                    ...
                    $content = '<pre class="with-hljs"><code style="background-color:#101010" class="' . $hljs_class . '">' . fm_enc($content) . '</code></pre>';
...
function fm_show_nav_path($path)
{
    ...
    ?>
    <nav style="background-color:black;" class="navbar navbar-dark bg-dark navbar-expand-lg  mb-4 main-nav <?php echo $isStickyNavBar ?>">
        <a style="color:white;" class="navbar-brand" href=""> <?php echo lng('AppTitle') ?> </a>
...
<head>
    ...
    <?php endif; ?>
    <style>
        body { font-size:14px;color:#222;background:#101010; }
        ...
        * { -webkit-border-radius:0 !important;-moz-border-radius:0 !important;border-radius:0 !important; }
        ...
        #main-table .filename a { color:white; }
        .table td, .table th { vertical-align:middle !important;background-color:#010101;color:white }
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Tiny File Manager';      $tr['en']['AppTitle']           = 'Administrador Archivos';
